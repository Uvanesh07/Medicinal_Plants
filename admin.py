...
winadmin = Tk()
winadmin.title("Identification of Different Medical Plants")
...
Label(winadmin, text='Identification of Different Medical Plants', bg="#ffb366", font='verdana 15 bold') \
    .place(x=120, y=120)
